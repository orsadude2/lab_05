...
function multiply(a,b){ //eslint-disable-line
  ...
  console.log(theProduct, productMessage);
}
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var addAB = sum(a,b)[0];
  var addABandC = sum(addAB, c)[0];
  var multAB = multiply(a,b)[0];
  var multABandC = multiply(multAB,c)[0];
  var element3 = a + ' and ' + b + ' and ' + c + ' sum to ' + addABandC + '.';
  var element4 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multABandC + '.';
  return[addABandC, multABandC, element3, element4];
...
function sumArray(testArray){ //eslint-disable-line
  var newA = testArray[0];
  console.log('newA' , newA);
  var newB = testArray[1];
  console.log('newB' , newB);

  var result = sum(newA,newB);
  result = result[0];
  console.log('result ', result);

  var newC = testArray[2];
  console.log('new c', newC);

  var result2 = sum(newC, result);

  result2 = result2[0];
  console.log('result2', result2);
  var element5 = newA + ',' + newB + ',' + newC + ' was passed in as an array of numbers, and ' + result2
+ ' is their sum.';
  console.log('message', element5);

  return[result2, element5];
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var multiplied = multiply(testArray[0], multiply(testArray[1],testArray[2])[0])[0];

  // var message2 =  'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multiplied + '.';
  var message2 =  'The numbers ' + testArray + ' have a product of ' + multiplied + '.';
  console.log(message2);
  return [multiplied, message2];
}
